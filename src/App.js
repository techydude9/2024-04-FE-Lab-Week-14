 ...
 *
 * xStep 1: Create a new component in your src folder called 'Appointments.js'
 *         Create the base format for a class based component in Appointments.js
 *
 * xStep 2: Render your Appointments.js component in your App.js component.
 *
 * xStep 3: Let's hold our information in our App.js, and pass that information
 ...
 *             ]
 *
 * xStep 4: Create a property on the <Appointments/> component called 'customers',
...
import './App.css'
import Nav from './Nav'
import Appointments from './Appointments'   //P1 Step2
